const ServicePackages = () => {
  return (
    <div className="sectionGap">
      <h1 className="text-2xl font-bold text-center mb-8">Service Packages</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-[12px]">
        {/* Operations Package */}
        <div>
          <div className="bg-[#FF8C00]  rounded-lg rounded-b-none  pb-[20px] max-h-[72px] flex justify-center items-center">
          ...
          <ul className="2xl:h-[420px] xl:h-[500px] lg:h-[350px] list-disc list-inside space-y-[10px] bg-white shadow-lg rounded-lg  rounded-t-none p-[20px] border border-gray-200">
            <li className="font-medium text-gray-700">Quarterly Mock Audits</li>
        ...
        <div>
          ...
          <ul className="2xl:h-[420px] xl:h-[500px] lg:h-[350px] list-disc list-inside space-y-2 bg-white shadow-lg rounded-lg rounded-t-none p-[20px] border border-gray-200">
            <li className="font-medium text-gray-700">SLPs and OTs </li>
            <p className="text-gray-600 text-sm">
        ...
        <div>
          <div className="bg-[#FF8C00] rounded-lg rounded-b-none max-h-[72px]">
            <h2
              className="menuText font-semibold text-center text-white px-[30px] 2xl:py-[24px] xl:py-[14px] 
            py-[24px]"
            >
              Customized Service Package
            </h2>
