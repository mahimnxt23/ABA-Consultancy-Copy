   ...
   2xl:mt-[100px]  grid-cols-1  grid  lg:grid-cols-2 gap-[30px] lg:gap-[100px] justify-center items-center"
					>
						...
						<div>
							...
							<p className="bodyText text-[#0E0D0DCC]/[.8] font-normal">
								Barry Alexander, M.A, LPCC, Qualified Supervising Professional
								Bachelor's degree in Child Psychology from Metropolitan State
								University, Master's degree in Counseling Psychology from the
								University of St. Thomas. I became a Licensed Professional
								Clinical Counselor (LPCC) in May 2016 and have held the
								designation of Board-Certified Supervisor since 2020. I have
								five years of experience working as a therapist in the mental
								health unit at Allina Health, where I conducted assessments and
								developed treatment plans for adult patients with chronic mental
								health conditions, including depression, anxiety disorders,
								schizophrenia, and bipolar disorder. Additionally, I have seven
								years of experience at Wilder Foundation as an embedded school
								therapist, where I worked with middle school students identified
								with social and emotional stress disorders that contribute to
								academic struggles and behavioral issues both in school and at
								home. For three years, I served as a crisis therapist at
								Washburn Center for Children, assisting adolescents and their
								families who were recently released from the hospital following
								a mental health emergency. In this role, I provided resources,
								treatment, and support to facilitate access to long-term mental
								health services. Furthermore, I have three years of experience
								in private practice, where I supervised graduate students of
								color as they worked towards obtaining their professional
								licensures.
							</p>
						</div>
