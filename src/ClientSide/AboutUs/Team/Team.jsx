    ...
    md:px-[32px] lg:px-[80px]  xl:px-[100px]  2xl:px-[150px] 
        ...
        >
          ...
          <p className=" bodyText text-white md:max-w-[550px] font-normal">
            ...
            exceptional guidance, innovative solutions, and personalized care to
            empower autism centers and their communities.
          </p>
        </div>
      </div>
          ...
          <div className=" meet-experts">
            <div className="ourservices max-w-[900px]">
              ...
              <p className="text-[#0E0D0DCC] bodyText mt-[20px] font-inter mb-[50px]">
                ...
                and dedication to help your business succeed. We work closely
                with you to deliver tailored solutions and achieve lasting
                results
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-[30px] lg:gap-[100px] justify-center items-center">
          ...
          <div>
            ...
            <p className="bodyText text-[#0E0D0DCC]/[.8] font-normal">
              ...
              COO for ABA Consultancy. Anne is known for ensuring each project
              receives the thoroughness and efficiency it deserves. Her
              expertise in multifamily, student housing, hospitality and
              ...
              drive for results allow us to maintain their forward momentum. In
              2015, Anne was named one of the Top Women in Finance by Finance
              and Commerce. In 2019 she received an In House Counsel Award from
              Finance & Commerce.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className="bodyText text-[#0E0D0DCC]/[.8] font-normal">
              ...
              using both traditional sources of financing and State/Federal
              LIHTC and historic tax credits. Paul has an MBA from Hamline
              University and is responsible for site selection, underwriting,
              debt & equity sourcing, closing and construction management.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p className="bodyText text-[#0E0D0DCC]/[.8] font-normal">
              ...
              experience to ABA Consultancy. Throughout his career, he’s
              overseen the completion of everything from market rate apartments
              to hotels, warehouses and medical office buildings. His deep
              knowledge in contract negotiation, estimating and construction
              management ensure every ABA Consultancy project is executed to the
        ...
        >
          ...
          <div>
            ...
            <p className="bodyText text-[#0E0D0DCC]/[.8] font-normal">
              ...
              buildings. Her love for bringing ideas to reality and her focus on
              ...
              running smoothly and guarantees they receive the time and
