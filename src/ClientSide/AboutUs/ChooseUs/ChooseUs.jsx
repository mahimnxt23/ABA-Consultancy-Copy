    ...
    md:px-[32px] lg:px-[80px]  xl:px-[100px]  2xl:px-[150px] 
        ...
        >
          ...
          <p className=" bodyText text-white md:max-w-[550px] font-normal">
            ...
            innovative strategies, expert guidance, and tailored resources that
      ...
      >
        <div className="w-full 2xl:max-w-[1000px] ">
          ...
          <p className="bodyText text-[#0E0D0DCC]/[.8] pb-[30px] lg:pb-[50px] font-normal">
            ...
            experienced professionals, we offer comprehensive solutions tailored
            to meet the unique needs of autism centers. From ensuring compliance
            with complex regulations to providing top-tier staffing solutions,
            we handle the operational challenges so you can focus on delivering
            exceptional care. Our proven track record of reliability includes
            guaranteed results, such as completing CMDEs within five days and
            preparing your team for audits through real-world mock scenarios.
          </p>
        </div>
        {/* card */}
