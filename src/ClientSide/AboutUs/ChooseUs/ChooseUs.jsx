          ...
          <div className="grid md:grid-col-1 lg:grid-cols-3 gap-[20px]">
            <div className="bg-[#FFFFFF] px-4 h-[350px] lg:h-[450px] rounded-[8px] text-center  relative overflow-hidden py-[50px] flex justify-center items-center">
              <div className="">
                ...
                <p className="bodyText  text-[#1F1E1ECC]/[.8]  font-normal">
                  We tailor our services to meet the specific goals and
                  challenges of your agency. Whether it’s staffing,
                  administrative support, or operational efficiency, we ensure
                  our solutions align perfectly with your needs.
                </p>
              </div>
            </div>
            <div className="bg-[#FFFFFF] px-4 h-[350px] lg:h-[450px] rounded-[8px] text-center  relative overflow-hidden py-[50px] flex justify-center items-center">
            ...
            <div className="bg-[#FFFFFF] px-4 h-[350px] lg:h-[450px] rounded-[8px] text-center  relative overflow-hidden py-[50px]  flex justify-center items-center">
              {/* <div>
                ...
                <h1 className=" pb-[8px] headThree text-[#FF8C00]  font-semibold">
                  Seamless Operations for Your Peace of Mind
                </h1>
                <p className="bodyText  text-[#1F1E1ECC]/[.8]  font-normal">
