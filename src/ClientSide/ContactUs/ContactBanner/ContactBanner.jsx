          ...
          <div className="grid grid-cols-1 gap-y-[50px]">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-[24px]">
              ...
              <div className=" flex justify-center items-center shadow-[4px_4px_12px_0px_rgba(0,0,0,0.4)] gap-x-[20px] p-[30px] bg-white">
                ...
                <div>
                  <h1 className="pb-[12px]">Phone Number</h1>
                  <p className="pb-[5px]">(229) 555-0109</p>
                  <p className="pb-[5px]">(229) 555-0109</p>
                </div>
              </div>
              ...
              <div className="flex justify-center items-center shadow-[4px_4px_12px_0px_rgba(0,0,0,0.4)] gap-x-[20px] p-[30px] bg-white">
                ...
                <div>
                  <h1 className="pb-[12px]">Address</h1>
                  <p className="pb-[5px]">2118 Thornridge Cir.</p>
                  <p className="pb-[5px]">Syracuse, Connecticut</p>
                </div>
              </div>
              ...
              <div className="flex justify-center items-center shadow-[4px_4px_12px_0px_rgba(0,0,0,0.4)] gap-x-[20px] p-[30px] bg-white">
                ...
                <div>
                  <h1 className="pb-[12px]">Email</h1>
                  <p className="pb-[5px]">admin@gmail.com</p>
                  <p className="pb-[5px]">contact@gmail.com</p>
                </div>
              </div>
